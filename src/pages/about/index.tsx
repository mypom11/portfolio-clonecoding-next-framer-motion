      ...
      <main className="flex w-full flex-col item-center justify-center dark:text-light">
        ...
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16">
            ...
            <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 dark:bg-dark dark:boder-light">
              <div className="absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-[2rem] bg-dark dark:bg-light"></div>
              <Image
                src={profileImage}
                alt="MinJeongki"
                className="w-full h-auto rounded-2x"
                priority
            ...
            <div className="col-span-2 flex flex-col items-end justify-between">
              <div className="flex flex-col items-end justify-center">
                ...
                <h2 className="text-xl font-medium capitalize text-dark dark:text-light/75">
                  Satisfied clients
                </h2>
              </div>
              <div className="flex flex-col items-end justify-center">
